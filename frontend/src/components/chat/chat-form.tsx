...
export function ChatForm({ isGenerating, isCompacting = false, onSend, onStop, className, sessionId, directory }: ChatFormProps) {
  ...
  const effectiveWorkspace = sessionId ? directory : globalWorkspace;
  const hasWorkspace = !!effectiveWorkspace && effectiveWorkspace !== ".";
  ...
  }, [input, attachments, isGenerating, isCompacting, hasWorkspace, onSend, ref, draftKey, t]);
